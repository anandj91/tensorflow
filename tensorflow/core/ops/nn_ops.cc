...
REGISTER_OP("AvgPool")
    ...
    .Attr("T: {half, bfloat16, custom, float, double}")
...
REGISTER_OP("FusedBatchNormV2")
    ...
    .Attr("T: {half, bfloat16, custom, float}")
    .Attr("U: {float}")
    .Attr("epsilon: float = 0.0001")
    .Attr(GetConvnetDataFormatAttrString())
    .Attr("is_training: bool = true")
...
REGISTER_OP("MaxPool3DGrad")
    ...
    .Attr(GetPaddingAttrString())
    .Attr(GetConvnet3dDataFormatAttrString())
    .Attr("T: {half, bfloat16, custom, float} = DT_FLOAT")
    .Attr("TInput: {half, bfloat16, custom, float} = DT_FLOAT")
    .SetShapeFn([](InferenceContext* c) {
      return UnchangedShapeWithRank(c, 5);
    });
...
REGISTER_OP("MaxPool")
    .Attr(
        "T: {half, bfloat16, custom, float, double, int32, int64, uint8, int16, int8, "
...
REGISTER_OP("_MklRelu")
    ...
    .Attr("T: {float, bfloat16, custom} = DT_FLOAT")
    .SetShapeFn(shape_inference::UnchangedShape)
    .Doc(R"doc(
...
REGISTER_OP("_MklMaxPool")
    .Attr("T: {float, half, bfloat16, custom} = DT_FLOAT")
    .Attr("ksize: list(int) >= 4")
    .Attr("strides: list(int) >= 4")
    .Attr(GetPaddingAttrString())
    .Attr(GetConvnetDataFormatAttrString())
...
REGISTER_OP("_MklAvgPool")
    ...
    .Attr(GetPaddingAttrString())
    .Attr(GetConvnetDataFormatAttrString())
    .Attr("T: {float, half, double, bfloat16, custom}")
    .SetShapeFn(shape_inference::AvgPoolShape)
    .Doc(R"doc(
...
REGISTER_OP("_MklToTf")
    ...
    .Input("mkl_input: uint8")
    .Output("output: T")
    .Attr("T: {half, float, double, bfloat16, custom, qint8, quint8, qint32}")
...
REGISTER_OP("_MklInputConversion")
    ...
    .Attr(
        "T: {half, float, bfloat16, custom, double, uint8, int8, uint16, int16, int32, "
