...
REGISTER7(MklBinaryOp, CPU, "_MklAdd", functor::add, float, Eigen::half, double,
          int32, int64, bfloat16, custom);
REGISTER9(MklBinaryOp, CPU, "_MklSub", functor::sub, float, Eigen::half, double,
          int32, int64, complex64, complex128, bfloat16, custom);
REGISTER7(MklBinaryOp, CPU, "_MklMul", functor::mul, float, Eigen::half, double,
          uint8, int32, bfloat16, custom);
REGISTER7(MklBinaryOp, CPU, "_MklMaximum", functor::maximum, float, Eigen::half,
          double, int32, int64, bfloat16, custom);
REGISTER7(MklBinaryOp, CPU, "_MklSquaredDifference",
