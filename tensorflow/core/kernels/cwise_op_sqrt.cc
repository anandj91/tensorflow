...
REGISTER7(UnaryOp, CPU, "Sqrt", functor::sqrt, float, Eigen::half, double,
          bfloat16, custom, complex64, complex128);
...
REGISTER7(SimpleBinaryOp, CPU, "SqrtGrad", functor::sqrt_grad, float,
          Eigen::half, bfloat16, custom, double, complex64, complex128);
#if GOOGLE_CUDA || TENSORFLOW_USE_ROCM
