...
REGISTER_OP("BatchMatMul")
    ...
    .Output("output: T")
    .Attr(
        "T: {bfloat16, custom, half, float, double, int32, int64, complex64, "
        "complex128}")
...
REGISTER_OP("Abs")
    .Input("x: T")
    .Output("y: T")
    .Attr("T: {bfloat16, custom, half, float, double, int32, int64}")
    .SetShapeFn(shape_inference::UnchangedShape);
...
#define UNARY_REAL()                              \
  Input("x: T")                                   \
      .Output("y: T")                             \
      .Attr("T: {bfloat16, custom, half, float, double}") \
      .SetShapeFn(shape_inference::UnchangedShape)

#define UNARY_COMPLEX()                                                  \
  Input("x: T")                                                          \
      .Output("y: T")                                                    \
      .Attr("T: {bfloat16, custom, half, float, double, complex64, complex128}") \
      .SetShapeFn(shape_inference::UnchangedShape)
...
#define BINARY_MORE()                                                          \
  Input("x: T").Input("y: T").Output("z: T").Attr(                             \
      "T: {bfloat16, custom, half, float, double, uint8, int8, uint16, int16, int32, " \
...
REGISTER_OP("Add")
    ...
    .Output("z: T")
    .Attr(
        "T: {bfloat16, custom, half, float, double, uint8, int8, int16, int32, int64, "
...
REGISTER_OP("_MklAdd")
    ...
    .Attr(
        ...
        "complex128, string, bfloat16, custom}")
    .SetShapeFn(shape_inference::BroadcastBinaryOpShapeFn)
    .Doc(R"doc(
...
REGISTER_OP("_MklMaximum")
    ...
    .Output("z: T")
    .Output("mkl_z: uint8")
    .Attr("T: {half, float, double, int32, int64, bfloat16, custom}")
    .SetShapeFn(shape_inference::BroadcastBinaryOpShapeFn)
    .Doc(R"doc(
...
REGISTER_OP("Mod")
    ...
    .Input("y: T")
    .Output("z: T")
    .Attr("T: {int32, int64, float16, half, bfloat16, custom, float, double}")
    .SetShapeFn(shape_inference::BroadcastBinaryOpShapeFn);
...
REGISTER_OP("FloorMod")
    ...
    .Input("y: T")
    .Output("z: T")
    .Attr("T: {int32, int64, bfloat16, custom, half, float, double}")
    .SetShapeFn(shape_inference::BroadcastBinaryOpShapeFn);
...
REGISTER_OP("Pow")
    ...
    .Output("z: T")
    .Attr(
        "T: {bfloat16, custom, float, half, double, int32, int64, complex64, "
        "complex128}")
    .SetShapeFn(shape_inference::BroadcastBinaryOpShapeFn);
...
#define EQUALITY_COMPARISON()                                              \
  Input("x: T")                                                            \
      ...
      .SetIsCommutative()                                                  \
      .Attr(                                                               \
          "T: {bfloat16, custom, half, float, double, uint8, int8, int16, int32, " \
...
REGISTER_OP("SparseMatMul")
    ...
    .Attr("Ta: {float, bfloat16, custom} = DT_FLOAT")
    .Attr("Tb: {float, bfloat16, custom} = DT_FLOAT")
    .SetShapeFn(shape_inference::MatMulShape);
...
REGISTER_OP("Range")
    ...
    .Input("delta: Tidx")
    .Output("output: Tidx")
    .Attr("Tidx: {bfloat16, custom, float, double, int32, int64} = DT_INT32")
    .SetShapeFn([](InferenceContext* c) {
      ShapeHandle unused;
...
REGISTER_OP("LinSpace")
    ...
    .Input("num: Tidx")
    .Output("output: T")
    .Attr("T: {bfloat16, custom, float, double}")
    .Attr("Tidx: {int32, int64} = DT_INT32")
    .SetShapeFn([](InferenceContext* c) {
      ShapeHandle unused;
      TF_RETURN_WITH_CONTEXT_IF_ERROR(c->WithRank(c->input(0), 0, &unused),
