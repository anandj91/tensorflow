...
constexpr std::array<DataType, 5> kFloatTypes = {
    {DT_HALF, DT_FLOAT, DT_DOUBLE, DT_BFLOAT16, DT_CUSTOM}};
constexpr std::array<DataType, 13> kNumericTypes = {
    {DT_UINT8, DT_UINT32, DT_UINT64, DT_INT8, DT_INT32, DT_INT64, DT_HALF,
     DT_FLOAT, DT_DOUBLE, DT_COMPLEX64, DT_COMPLEX128, DT_BFLOAT16, DT_CUSTOM}};

constexpr std::array<DataType, 17> kCpuAllTypes = {
