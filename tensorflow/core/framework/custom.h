...
#ifndef TENSORFLOW_CORE_FRAMEWORK_CUSTOM_H_
#define TENSORFLOW_CORE_FRAMEWORK_CUSTOM_H_
...
// Conversion routines between an array of float and custom of
// "size".
...
#endif  // TENSORFLOW_CORE_FRAMEWORK_CUSTOM_H_
