...
TF_CALL_custom(REGISTER_MKL_FUSED_BATCHNORM_CPU);
...
REGISTER_MKL_FUSED_BATCHNORM_V2_CPU(custom, float);
...
TF_CALL_custom(REGISTER_MKL_FUSED_BATCHNORM_GRAD_CPU);
...
REGISTER_MKL_FUSED_BATCHNORM_GRAD_V2_CPU(custom, float);
